...
<label>Mail Id<span style="color: red;">*</span></label>
  ...
  <div class="col" >
      <div class="wrapper">
      <div class="input_field">
        <input type="textarea"  rows="4" id="body" required>
        <div class="underline">
</div>
...
<button type="button" class="btn btn-outline-secondary submit-button" onclick="sendEmail()" value="Send An Email" style="margin-top: 2%;background-color: red;color: white;" >Submit</button>
        ...
        <div class="right box">
          ...
          <div class="content">
            <div class="social">
              ...
              <a href="https://discord.gg/CfMhHFkJ7Z"><span class="fab fa-discord" ></span></a>
            </div>
          </div>
        </div>
      </div>
